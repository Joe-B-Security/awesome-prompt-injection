...
- [AICU](https://github.com/Jake-Schoellkopf/aicu) - Modular black-box LLM security scanner with single-turn, multi-turn (crescendo-style), and indirect file-based prompt injection testing. YAML-driven payloads, Best-of-N variant generation, and a strict evaluator to minimize false positives.
