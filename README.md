...
- [Darkmoon](https://github.com/ASCIT31/Dark-Moon) - Open-source (GPL-3.0) Privacy Gateway and command gateway that blocks data exfiltration to the LLM: real IPs, hosts, credentials and PII are swapped for deterministic placeholders and rehydrated locally, so any exfiltrated values are meaningless.
