...
- [PwnClaw](https://pwnclaw.com) - AI agent security testing platform with 112 attacks across 14 categories including prompt injection, jailbreaks, MCP poisoning, and agency hijacking. Tests agents end-to-end without API keys.
