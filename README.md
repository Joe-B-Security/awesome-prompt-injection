...
- [Scopra](https://github.com/MrLightful/scopra) - Business-rule safeguards for AI agents. It lets teams encode organization-specific policies and evaluate agent inputs and outputs against them before continuing, blocking, or escalating.
