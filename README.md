...
- [ClawSec](https://clawsec.com/) - Security audit platform for AI agent skills that detects prompt injection vectors, tool poisoning, and unsafe patterns through 5-tier analysis including Firecracker sandbox execution
