...
- [API Relay Audit](https://github.com/toby-bridges/api-relay-audit) - Local audit tool for AI API relays and LLM proxies; checks relay-layer prompt injection, prompt extraction, instruction override, tool-call rewriting, error leakage, SSE anomalies, and Web3 wallet probes.
