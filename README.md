...
- [TWZRD Agent Intel](https://intel.twzrd.xyz) - On-chain trust scoring for AI agent wallets on Solana. Verify agent identity and behavioral history before authorizing x402 micropayment-gated actions — defense-in-depth against prompt injection by unknowing agents. MCP: , . [MCP endpoint](https://intel.twzrd.xyz/mcp)
