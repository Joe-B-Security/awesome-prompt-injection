...
- [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard) - Rust-native local scanner for AI-agent prompt injection, credential leakage, exfiltration, and risky tool-call context, with Cargo/Python installs and local feedback learning.
