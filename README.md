...
- [ai-injection-guard](https://github.com/LuciferForge/prompt-shield) - Lightweight prompt injection detector with 75 regex patterns across 9 attack categories (role override, context manipulation, encoding attacks, multilingual). Designed as a <1ms, zero-dependency pre-filter layer before heavier ML-based scanners. Also includes LLM output scanning for secrets, PII, and system prompt leakage.
