...
- [Omega Walls](https://github.com/synqratech/omega-walls) - Open-source stateful prompt injection defense for RAG and agent pipelines. Designed to detect cross-step and cross-document injection patterns, secret-exfiltration pressure, and tool/action abuse before malicious content reaches the control loop.
