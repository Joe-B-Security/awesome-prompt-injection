...
- [Agent Browser Shield](https://github.com/pixiebrix/agent-browser-shield) - Browser extension that sits between an AI agent and web pages, stripping prompt injection (hidden text and HTML comments) before content reaches the model. Also masks PII/credentials and removes dark patterns. Source-available (PolyForm Shield).
