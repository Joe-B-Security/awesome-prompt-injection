...
- [anve-offsec](https://github.com/ANVEAI/anve-offsec) - Autonomous AI security engineer & bug bounty platform in Kali Linux featuring input/output guardrails against prompt injection, destructive command blocking, and legal scope auditing. 🇮🇳
