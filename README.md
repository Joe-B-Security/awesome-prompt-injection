...
- [asqav](https://github.com/jagmarques/asqav-compliance) - Open-source CI/CD scanner that detects prompt injection risks, missing input validation, and absent guardrails in AI agent code. Runs as a GitHub Action or Python SDK to catch vulnerabilities before deployment.
