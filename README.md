...
- [APort Integrations](https://github.com/aporthq/aport-integrations) - Open-source agent identity and policy-enforcement middleware for tool calls; places authorization before side effects so prompt-injected agents still need to pass deterministic allow/deny checks.
