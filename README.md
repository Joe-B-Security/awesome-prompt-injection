...
- [CoT Red Team Agent](https://github.com/rudrasatani13/cot-redteam-agent) - CLI and Python API that red-teams visible LLM chain-of-thought and agent actions. Honest scoring (a refusal that quotes a canary is not success), keyless mock provider, local llama.cpp/vLLM support, CI scan, OWASP LLM Top 10 tags, and a Proof-of-Action simulated agent world.
