...
- [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard) - Local Rust scanner for AI-agent prompt injection, sensitive-data requests, exfiltration-style text, safety bypass, credential redaction, and dangerous tool-call context. Returns structured JSON verdicts for runtime enforcement.
